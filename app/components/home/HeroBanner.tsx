      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full grid lg:grid-cols-2 gap-12 lg:gap-8 items-center mt-10">
        ...
        <div className="flex flex-col items-start gap-8 lg:pr-10">
          ...
          <div className="animate-fade-in-up-delay-4 flex items-center gap-4">
            <div className="flex -space-x-3">
              {[1, 2, 3, 4].map((i) => (
                <div key={i} className={`w-10 h-10 rounded-full border-2 border-slate-50 dark:border-slate-950 flex items-center justify-center text-xs font-bold text-white shadow-sm ring-2 ring-transparent bg-gradient-to-br ${i === 1 ? 'from-blue-400 to-indigo-500' :
              ...
              <div className="w-10 h-10 rounded-full border-2 border-slate-50 dark:border-slate-950 bg-slate-200 dark:bg-slate-800 flex items-center justify-center text-xs font-bold text-slate-600 dark:text-slate-300 shadow-sm ring-2 ring-transparent">
                +2k
              </div>
            </div>
        ...
        <div className="relative flex justify-center lg:justify-end animate-slide-in-right">
          <div className="relative w-full max-w-lg aspect-[5/4] sm:aspect-[4/3] group">
            ...
            {/* Content cut-out line decorator (optional aesthetic matching the ticket) */}
            <div className="absolute top-0 bottom-0 left-1/2 -translate-x-1/2 w-0 border-l-2 border-dashed border-white/20 dark:border-black/20 pointer-events-none mix-blend-overlay hidden md:block" />
            ...
            <div className="absolute -left-6 top-1/4 animate-float z-20 hidden md:flex items-center gap-3 bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl p-3 pr-5 rounded-2xl border border-black/5 dark:border-white/10 shadow-xl">
              <div className="w-10 h-10 rounded-xl bg-orange-100 dark:bg-orange-500/20 flex items-center justify-center text-lg text-orange-500">
                ✨
              </div>
              <div>
            ...
            <div className="absolute -right-4 bottom-1/4 animate-float-delayed z-20 hidden md:flex items-center gap-3 bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl p-3 pr-5 rounded-2xl border border-black/5 dark:border-white/10 shadow-xl">
              <div className="w-10 h-10 rounded-xl bg-blue-100 dark:bg-blue-500/20 flex items-center justify-center text-lg text-blue-500">
                💻
              </div>
              <div>
